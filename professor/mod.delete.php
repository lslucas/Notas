<?php
 ...
 if(isset($_GET['verifica'])) {
	...
	if (file_exists($var['path'].'/mod.galeria.delete.php')) 
 	...
 	if (file_exists($var['path'].'/mod.r_prof_turmas.delete.php')) 
	 include_once $var['path'].'/mod.r_prof_turmas.delete.php';

 	if (file_exists($var['path'].'/mod.r_prof_atividade.delete.php')) 
	 include_once $var['path'].'/mod.r_prof_atividade.delete.php';

 	if (file_exists($var['path'].'/mod.r_prof_disciplinas.delete.php')) 
	 include_once $var['path'].'/mod.r_prof_disciplinas.delete.php';
