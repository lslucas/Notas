<?php
 $sql_guarda = "SELECT rpa_adm_id id FROM ".TABLE_PREFIX."_r_prof_atividade WHERE rpa_adm_id=?";
 ...
 if(isset($_GET['verifica'])) {
	...
	echo $num;
     ...
     $sql_rem = "DELETE FROM ".TABLE_PREFIX."_r_prof_atividade WHERE rpa_adm_id=?";
