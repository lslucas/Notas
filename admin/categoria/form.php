...
*/ ?>
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" class="input-xlarge" placeholder='Ano' name='ano' id='ano' value='<?=$val['titulo']?>'>
        <p class="help-block">Informe o ano da <b>turma</b></p>
      </div>
    </div>
    ...
    <div class="control-group">
      ...
      <div class="controls">
		  <select name='area' id='area' class='required'>
			...
			<option value='Atividade' <?php if($val['area']=='Atividade') echo ' selected';?>>Atividade</option>
			<option value='Disciplinas' <?php if($val['area']=='Disciplinas') echo ' selected';?>>Disciplinas</option>
			<option value='Turmas' <?php if($val['area']=='Turmas') echo ' selected';?>>Turmas</option>
		  </select>
