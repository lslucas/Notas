<?php
 ...
 $sql_guarda = "SELECT adm_id id, adm_nome FROM ".TABLE_PREFIX."_administrador WHERE adm_id=?";
...
*/
	echo $num;
     ...
     $sql_rem = "DELETE FROM ".TABLE_PREFIX."_administrador WHERE adm_id=?";
